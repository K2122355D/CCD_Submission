...
def index():
    if request.method == "POST":
        ...
        s1 = "The score of credit card risk default is base on regression is "+ str(pred1)
        model2 = joblib.load('CCD_GB')
        pred2 = model2.predict([[income,age,loan]])
        s2 = "The score of credit card upgrade base on gradient booster is "+ str(pred2)
        ...
        s5 = "The score of credit card upgrade base on random forest is "+ str(pred5)
